...
/* Compact */
.pdp-head { margin: 2px 0 10px; }
.pdp-head h1 { font-size: 18px; }
.pdp-head .sub { font-size: 11px; margin-top: 2px; }
.annee select { padding: 6px 9px; font-size: 13px; }
.alert, .ok { padding: 7px 10px; font-size: 12px; margin: 0 0 8px; }
.btn { padding: 7px 14px; font-size: 13px; }
.search-row { margin-bottom: 8px; }
.search-input { padding: 6px 10px; font-size: 12px; }
.search-count { font-size: 12px; }
.table-scroll { max-height: calc(100vh - 158px); }
table.grid { font-size: 11.5px; }
table.grid th { font-size: 10px; padding: 5px; }
table.grid td { padding: 3px 6px; }
.cell { padding: 2px; }
.cell input { width: 74px; font-size: 11.5px; padding: 4px 5px; }
.desig { font-size: 10.5px; }
.cond-cell select { padding: 3px 6px; font-size: 11px; max-width: 130px; }
