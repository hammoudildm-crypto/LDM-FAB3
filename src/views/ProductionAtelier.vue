...
function exporterExcel() {
  ...
  telechargerXlsx('lots_fabriques_par_atelier_' + anneeSel.value, 'Lots par atelier ' + anneeSel.value, entetes, lignes)
}
    ...
    <template v-if="!chargement">
      ...
      <section class="card">
        <div class="card-head">
          ...
          <button class="btn-exp" @click="exporterExcel" :disabled="!grandTotal" title="Télécharger un fichier Excel (.xlsx)">Exporter Excel</button>
        </div>
        <div class="table-scroll">
          <table class="grid">
            <thead>
