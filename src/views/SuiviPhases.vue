      ...
      <template v-if="lotId">
        <section class="card">
          ...
          <div class="form-grid">
            ...
            <label>Quantité entrée<input v-model="form.quantite_entree" type="number" placeholder="500000" /></label>
            <label>Quantité sortie<input v-model="form.quantite_sortie" type="number" placeholder="492000" /></label>
        ...
        <section class="card">
          ...
          <div class="table-scroll">
            <table class="grid">
              <thead>
                <tr>
                  <th>Phase</th><th>Ligne</th><th class="right">Entrée</th><th class="right">Sortie</th>
