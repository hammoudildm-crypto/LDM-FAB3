...
.style-switch { position: fixed; z-index: 90; top: 16px; left: 50%; transform: translateX(-50%); display: flex; align-items: center; gap: 4px; background: rgba(255,255,255,.92); backdrop-filter: blur(10px); border: 1px solid #e2e8f0; border-radius: 999px; padding: 5px 6px; box-shadow: 0 10px 30px rgba(15,23,42,.22); }
...
@media (max-width: 760px) { .style-switch { flex-wrap: wrap; justify-content: center; width: calc(100% - 20px); border-radius: 16px; top: 10px; } .ss-lbl { width: 100%; text-align: center; padding: 2px 0 4px; } }
...
.m-convoyeur .hint { text-align: center; font-size: 11.5px; font-weight: 700; color: #94a3b8; letter-spacing: 1.5px; text-transform: uppercase; margin-bottom: 40px; }
