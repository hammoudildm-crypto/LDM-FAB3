  ...
  <div class="hub-root">
    <div v-if="!authSession" class="hub-login">
      <div class="hub-login-card">
        ...
        <h2>Bienvenue</h2>
        <p class="hub-login-txt">Connectez-vous pour accéder à l'application.</p>
        <a href="#/login" class="hub-login-btn">Se connecter</a>
      </div>
    </div>
...
.hub-login-card { background: #fff; border-radius: 18px; padding: 34px 36px; width: 340px; max-width: 90vw; box-shadow: 0 24px 60px rgba(0,0,0,.35); text-align: center; }
.hub-login-brand { font-weight: 800; letter-spacing: .04em; color: #0f766e; margin-bottom: 8px; }
.hub-login-card h2 { margin: 0 0 8px; font-size: 22px; color: #0f2a33; }
.hub-login-txt { color: #64748b; font-size: 14px; margin: 0 0 22px; }
.hub-login-btn { display: inline-block; padding: 13px 30px; border: none; border-radius: 10px; background: #0f766e; color: #fff; font-weight: 700; font-size: 15px; cursor: pointer; text-decoration: none; }
